...
og_source_train_dl, og_source_val_dl, og_source_test_dl = build_ORACLE_episodic_iterable(
    ...
    num_examples_per_device_per_distance_per_run=num_examples_per_class_per_domain_source,
    iterator_seed=seed,
...
og_target_train_dl, og_target_val_dl, og_target_test_dl = build_ORACLE_episodic_iterable(
    ...
    window_length=window_length,
    window_stride=window_stride,
    num_examples_per_device_per_distance_per_run=num_examples_per_class_per_domain_target,
    iterator_seed=seed,
    dataset_seed=dataset_seed,
